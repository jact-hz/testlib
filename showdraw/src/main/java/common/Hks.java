...
/**
 * Created by MX on 4/10 0010.
 */
public class Hks {
    //wpfcommon 与用户不相关的配置
    public static final String guide_activity = "guide_activity"; //引导界面
    ...
    public static final String project_member_power = "project_member_power";       //项目成员权限
    ...
    public static final String key_cos = "key_cos";            //项目列表
    public static final String key_realcos = "key_realcos";     //企业列表
    ...
    public static final String key_customer_visit = "key_customer_visit"; //客户拜访

    public static final String company_plug = "company_plug";
    public static final String shot_set = "shot_set";  //摇一摇
    public static final String take_photo_path = "take_photo_path"; //拍照路径
    public static final String last_notification_time = "last_notification_time"; //上次提醒时间
    public static final String notification_counts = "notification_counts"; //提醒了多少次
    ...
    public static final String font_protion = "font_protion";  //显示比例
    ...
    //    public static final String yes_rule_id = "yes_rule_id";
    //上次过天的打卡时间
