...
import com.weqia.utils.reflect.ClassUtils;
import com.weqia.utils.reflect.FieldUtils;
    ...
    public static TableInfo get(Class<?> clazz) {
        ...
        if (tableInfo == null) {
            ...
            if (idField != null) {
                ...
                throw new IllegalArgumentException("the class[" + clazz + "]'s idField is null");
            }
