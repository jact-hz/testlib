...
public class FadeInBitmapDisplayer implements BitmapDisplayer {
	...
	protected final boolean animateFromNetwork;
	protected final boolean animateFromDisk;
	protected final boolean animateFromMemory;
    ...
    @Override
    public void display(Bitmap bitmap, ImageAware imageAware, LoadedFrom loadedFrom, String key) {
