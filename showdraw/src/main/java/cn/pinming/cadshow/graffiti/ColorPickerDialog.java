...
public class ColorPickerDialog extends Dialog {
    ...
    private class ColorPickerView extends View {
        ...
        public ColorPickerView(Context context, int height, int width) {
            ...
            mPaint.setStrokeWidth(ComponentUtil.dip2px(context,30));//圆环大小
            ...
            mRectPaint.setStrokeWidth(ComponentUtil.dip2px(context,5));
            rectLeft = -r - mPaint.getStrokeWidth() * 0.5f;
            rectTop = r + mPaint.getStrokeWidth() * 0.5f +
                    mLinePaint.getStrokeMiter() * 0.5f + 15;
            rectRight = r + mPaint.getStrokeWidth() * 0.5f;
            rectBottom = rectTop + ComponentUtil.dip2px(context,30);
        }
    ...
    public void show() {
        super.show();
        int height = ComponentUtil.dip2px(context, 220);
        int width = ComponentUtil.dip2px(context, 180);
