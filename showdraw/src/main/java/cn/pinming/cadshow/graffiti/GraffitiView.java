...
import static cn.pinming.cadshow.graffiti.DrawUtil.GRAFFITI_PIXEL_UNIT;
import static cn.pinming.cadshow.graffiti.DrawUtil.computeAngle;
import static cn.pinming.cadshow.graffiti.DrawUtil.drawArrow;
import static cn.pinming.cadshow.graffiti.DrawUtil.drawCircle;
import static cn.pinming.cadshow.graffiti.DrawUtil.drawLine;
import static cn.pinming.cadshow.graffiti.DrawUtil.drawRect;
import static cn.pinming.cadshow.graffiti.DrawUtil.drawRectWavy;
...
public class GraffitiView extends View {
    ...
    public void init() {
        ...
        mScale = 1f;
        mColor = new GraffitiColor(getResources().getColor(R.color.red));
        mPaint = new Paint();
        ...
        mAmplifierPaint.setStrokeWidth(ComponentUtil.dip2px(getContext(), 10));
    }
    ...
    private void setBG() {// 不用resize preview
        ...
        DrawUtil.setGraffitiPixelUnit(ComponentUtil.dip2px(getContext(),1) / mPrivateScale);
    ...
    private void draw(Canvas canvas, Pen pen, Shape shape, Paint paint, float sx, float sy, float dx, float dy, Matrix matrix, GraffitiColor color, int degree) {
        ...
        switch (shape) { // 绘制图形
            ...
            case HOLLOW_CIRCLE:
                ...
                break;
            case CLOUD_LINE:
                drawRectWavy(canvas, sx, sy, dx, dy, paint);
                break;
            case FILL_RECT:
                paint.setStyle(Paint.Style.FILL);
            case HOLLOW_RECT:
