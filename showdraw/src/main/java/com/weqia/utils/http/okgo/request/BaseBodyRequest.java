...
public abstract class BaseBodyRequest<R extends BaseBodyRequest> extends BaseRequest<R> implements HasBody<R> {
    ...
    @SuppressWarnings("unchecked")
    @Override
    public R addFileWrapperParams(String key, List<RequestParams.FileWrapper> fileWrappers) {
    ...
    public R upString(String string) {
        this.string = string;
        this.mediaType = RequestParams.MEDIA_TYPE_PLAIN;
        return (R) this;
    }
    ...
    public R upJson(String json) {
        this.json = json;
        this.mediaType = RequestParams.MEDIA_TYPE_JSON;
        return (R) this;
    }
    ...
    public R upBytes(byte[] bs) {
        this.bs = bs;
        this.mediaType = RequestParams.MEDIA_TYPE_STREAM;
        return (R) this;
    }
    ...
    public RequestBody generateRequestBody() {
        ...
        return ParamsUtils.generateMultipartRequestBody(params);
    }
}