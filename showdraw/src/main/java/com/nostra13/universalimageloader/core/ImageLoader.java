...
//    public static String TAG = ImageLoader.class.getSimpleName();
	...
	protected static final String LOG_LOAD_IMAGE_FROM_MEMORY_CACHE = "Load image from memory cache [%s]";
    ...
    protected ImageLoaderEngine engine;

    protected final ImageLoadingListener emptyListener = new SimpleImageLoadingListener();
...
//	}
	...
	public synchronized void init(ImageLoaderConfiguration configuration) {
		...
		if (this.configuration == null) {
		    UILL.d(LOG_INIT_CONFIG);
			engine = new ImageLoaderEngine(configuration);
			this.configuration = configuration;
		} else {
		    UILL.w(WARNING_RE_INIT_CONFIG);
		}
	}
	 ...
	 * @throws IllegalArgumentException if passed <b>imageAware</b> is null
	 */
	public abstract void displayImage(String uri, ImageAware imageAware, DisplayImageOptions options,
	...
	public Bitmap loadImageSync(String uri, ImageSize targetImageSize, DisplayImageOptions options) {
		...
		if (listener.getLoadedBitmap() == null) {
            listener.onLoadingFailed(uri, null, null);
            return null;
        } else {
	 ...
	 */
	public void destroy() {
		if (configuration != null) UILL.d(LOG_DESTROY);
		stop();
	...
	public static class SyncImageLoadingListener extends SimpleImageLoadingListener {
		...
		private SyncLoadInterface syncLoadInterface;

		@Override
		public void onLoadingComplete(String imageUri, View view, Bitmap loadedImage) {
			this.loadedImage = loadedImage;
			if (syncLoadInterface != null) {
                syncLoadInterface.onLoadingComplete(imageUri, view, loadedImage);
            }
		}
		...
		public void setSyncLoadInterface(SyncLoadInterface syncErrorInterface) {
            this.syncLoadInterface = syncErrorInterface;
        }
		
		@Override
		public void onLoadingFailed(String imageUri, View view, FailReason failReason) {
		    if (syncLoadInterface != null) {
		        syncLoadInterface.onLoadError(imageUri, view, failReason);
            }
		}
	}
}
