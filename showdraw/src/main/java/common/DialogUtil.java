...
//        datas.add(data3);
     ...
     * @return
     */
    public static Dialog initClearOneRecordDialog(Context ctx, OnClickListener onClickListener) {
        SharedFullScreenDialog dialog = new SharedFullScreenDialog(ctx);
    ...
    public static Dialog commonClearDialog(Context ctx, OnClickListener onClickListener, String title, int index) {
        SharedFullScreenDialog dialog = new SharedFullScreenDialog(ctx);
    ...
    public static Dialog initClearDbDialog(Context ctx, OnClickListener onClickListener) {
        SharedFullScreenDialog dialog = new SharedFullScreenDialog(ctx);
    ...
    // 退出企业
    public static Dialog exitCoDialog(Context ctx, OnClickListener onClickListener) {
        SharedFullScreenDialog dialog = new SharedFullScreenDialog(ctx);
        DialogData data1 =
     ...
     * @return
     */
    public static Dialog iniLogoutDialog(Context ctx, OnClickListener onClickListener) {
        SharedFullScreenDialog dialog = new SharedFullScreenDialog(ctx);
        DialogData data1 =
