...
public interface ImageLoadingListener {
	...
	void onLoadingFailed(String imageUri, View view, FailReason failReason, String tag);
	/**
	...
	void onLoadingComplete(String imageUri, View view, Bitmap loadedImage, String tag);
