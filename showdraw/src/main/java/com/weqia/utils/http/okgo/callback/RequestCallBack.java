...
*/
public abstract class RequestCallBack<T> implements Converter<T> {
   ...
   /** 对返回数据进行操作的回调， UI线程 */
   public abstract void onSuccessData(T t, Call call, Response response);
