...
import com.weqia.component.rcmode.recyclerView.interfaces.OnNetWorkErrorListener;
import com.weqia.component.rcmode.recyclerView.view.LoadingFooter;
...
public class LuRecyclerView extends RecyclerView {
    ...
    private com.weqia.component.rcmode.recyclerView.LuRecyclerViewAdapter mWrapAdapter;
    ...
    public void setAdapter(Adapter adapter) {
        ...
        mWrapAdapter = (com.weqia.component.rcmode.recyclerView.LuRecyclerViewAdapter) adapter;
    ...
    private class DataObserver extends RecyclerView.AdapterDataObserver {
        ...
        public void onItemRangeMoved(int fromPosition, int toPosition, int itemCount) {
            ...
            mWrapAdapter.notifyItemMoved(fromPosition + headerViewsCountCount, toPosition + headerViewsCountCount);
        }
