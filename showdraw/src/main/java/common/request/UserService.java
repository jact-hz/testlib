...
public class UserService {
    ...
    public static String httpStr = "http://172.16.9.28:8081/front/bimfile/modelConstructInfoCors";
...
//        serverIp = "172.16.9.28:8081";
        serverIp = "172.16.10.35:8081";
...
//        }
    ...
    public static boolean getDataFromServer(Boolean bShowDlg, String path, ServiceParams params,
                                            ServiceRequester serviceRequester) {
        return getDataFromServer(bShowDlg, path, params, false, serviceRequester);
    }

    public static boolean getDataFromServer(Boolean bShowDlg, String path, final ServiceParams params,
                                            boolean cache, final ServiceRequester serviceRequester) {
...
//            params.urlParams = map;       // TODO: 2019/1/23 sdk不需要加密
        }
        return returnStr;
    }
...
//                        + RequestType.valueOf(params.getItype()).strName() + ":");
    ...
    public static ResultEx getSyncInfo(ServiceParams params, String path) {
        Map<String, ?> paramsMap = RefUtil.getFieldValueMap(params);
        if (paramsMap == null) {
            return null;
        } else {
